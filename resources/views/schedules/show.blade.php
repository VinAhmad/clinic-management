...
<div class="container">
    <div class="row mb-3">
        <div class="col-md-8">
            <h2>{{ __('Dr. :name\'s Schedule', ['name' => $doctor->name]) }}</h2>
        </div>
        <div class="col-md-4 text-end">
            <a href="{{ route('schedules.create') }}?doctor_id={{ $doctor->id }}" class="btn btn-primary">
        ...
        <div class="card-body">
            @if($schedules->isEmpty())
                <div class="alert alert-info">
                    {{ __('This doctor has not created any schedules yet.') }}
                </div>
            @else
                                ...
                                <tr>
                                    ...
                                    @else
                                        <td colspan="3" class="text-center">
                                            <a href="{{ route('schedules.create') }}?doctor_id={{ $doctor->id }}&day={{ $day }}" class="btn btn-sm btn-outline-primary">

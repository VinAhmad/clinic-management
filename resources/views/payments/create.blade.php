                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('payments.store') }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="transaction_id" type="text" class="form-control @error('transaction_id') is-invalid @enderror" name="transaction_id" value="{{ old('transaction_id') }}" required>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="payment_date" type="datetime-local" class="form-control @error('payment_date') is-invalid @enderror" name="payment_date" value="{{ old('payment_date') ?? now()->format('Y-m-d\TH:i') }}" required>
                                @error('payment_date')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
